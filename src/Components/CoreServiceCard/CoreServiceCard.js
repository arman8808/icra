...
function CoreServiceCard() {
  return (
    <div className='p-[1.5rem] rounded-md flex items-start justify-start flex-col gap-4 ease-in-out duration-300 transition-colors hover:bg-[#DCFDCA] cursor-pointer'>
        ...
        <h2 className='text-blackShade font-bold text-lg'>Integrity</h2>
        <p className='text-secondTextColor text-sm font-normal' >We believe in transparency and building long-lasting relationships based on trust.</p>
    </div>
  )
}
