...
function AmazingPortfolioCard({ image, title, para }) {
  return (
    <div className="flex items-center justify-center relative mobile:w-fit">
      ...
      <span className="absolute bg-white bottom-0 right-[-7rem] mobile:right-[-0.5rem] w-[100%] h-[70%] p-4 rounded-md flex item-start justify-start gap-4 flex-col opacity-80">
